...
class SGD(Optimizer):
    ...
    def get_updates(self, params, constraints, loss, layer_masks):
        grads = self.get_gradients(loss, params)
        lr = self.lr * (1.0 / (1.0 + self.decay * self.iterations))
        updates = [(self.iterations, self.iterations + 1.)]

        for p, g, c, layer_mask in zip(params, grads, constraints,layer_masks):
...
class RMSprop(Optimizer):
    ...
    def get_updates(self, params, constraints, loss,layer_masks):
        ...
        for p, g, a, c, layer_mask in zip(params, grads, accumulators, constraints,layer_masks):
...
class Adagrad(Optimizer):
    ...
    def get_updates(self, params, constraints, loss,layer_masks):
        ...
        for p, g, a, c, layer_masks in zip(params, grads, accumulators, constraints,layer_masks):
...
class Adadelta(Optimizer):
    ...
    def get_updates(self, params, constraints, loss,layer_masks):
        ...
        for p, g, a, d_a, c, layer_mask in zip(params, grads, accumulators, delta_accumulators, constraints,layer_masks):
            new_a = self.rho * a + (1 - self.rho) * g ** 2 # update accumulator
            updates.append((a, new_a))
